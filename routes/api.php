...
use App\Http\Controllers\Api\V1\RewardSystemController;
use App\Http\Controllers\Api\V1\ShippingController;
use App\Http\Controllers\Api\V1\ShopController;
use App\Http\Controllers\Api\V1\UserController;
use App\Http\Controllers\Api\V1\VideoShoppingController;
...
Route::prefix('v1')->group(function() {
    Route::middleware(['CheckApiKey'])->group(function () {
        ...
        Route::post('phoneRegister', [AuthController::class, 'phoneRegister']);
        Route::post('verify-phone', [AuthController::class, 'verify_phone']);
        ...
        Route::prefix('user')->middleware(['jwt.verify'])->group(function (){
            ...
            //chat system
            Route::get('sellers',[\App\Http\Controllers\Api\V1\ChatSystemController::class,'sellers']);
            Route::get('messages',[\App\Http\Controllers\Api\V1\ChatSystemController::class,'messages']);
            Route::post('send-message',[\App\Http\Controllers\Api\V1\ChatSystemController::class,'sendMessage']);
        });
        ...
        Route::controller(\App\Http\Controllers\Api\V1\CampaignController::class)->group(function (){
