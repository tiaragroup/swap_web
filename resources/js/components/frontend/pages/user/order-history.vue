                    ...
                    <div class="col-lg-9">
                        <div class="sg-table">
                            <div class="title justify-content-between">
                                <h1 v-if="lengthCounter(profileOrders.data)>0">{{lang.order_history}}</h1>
                                <h1 v-else-if="lengthCounter(profileOrders.data)==0">{{lang.no_order_founds}}</h1>
                                <h1 v-else >{{lang.loading}}</h1>
                            </div>
                            <form class="woocommerce-cart-form" action="#">
                                <orders :orders="profileOrders.data" :user_dashboard="false"  v-if="is_shimmer"></orders>
                                <table class="table mb-3" v-for="(profileOrders,index) in 8 " v-else-if="shimmer">
