      ...
      <div class="user-chatbox">
        ...
        <div class="chatbox-form" id="chatbox-form">
          <div class="chatbox" id="chatbox">
            <div v-for="(message,index) in messages" :key="index" v-if="messages.length > 0 && authUser && authUser.user_type == 'customer'">
              <p style="text-align:center">{{ dateConvert(message.created_at) }}</p>
