    ...
    public function downloadUpdateFile()
    {
        try {
            ...
            $fields = [
                ...
                'version' => settingHelper('current_version')+1,
            ...
            if(is_dir($update_file_path))
            {
                ...
                if(file_exists($config_file)) {
                    ...
                    try {
                        ...
                        return "Please check your file permissions. Following directories should be 0777 permission: 1.app 2. bootstrap 3. config 4.database 5.public 6.resources 7.routes 8.storage 9.vendor";
                    }
                }
                else{
